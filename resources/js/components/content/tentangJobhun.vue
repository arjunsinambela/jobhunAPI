        ...
        <div class="col-md-12 wow fadeIn" data-wow-delay="0.2s">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Tentang Jobhun Sip</h6>
                </div>
                <!-- Card Body -->
                <div class="container">
                    <br>
                    ...
                    <h5>Visi Jobhun</h5>
                    <p>Menjadi portal penunjang karier nomor satu di Indonesia. Dikenal dan bisa berdampak nyata bagi karier masyarakat Indonesia.</p>
                    <h5>Misi Jobhun</h5>
                    <ol>
                        <li>Membantu mengurangi angka pengangguran di Indonesia dengan menyediakan layanan dan program yang dapat menunjang karier masyarakat.</li>
                        <li>Mengedukasi dan menyebarkan berbagai macam informasi yang berguna untuk perkembangan karier.</li>
